					...
					<div className="flex flex-wrap justify-center items-center rounded-lg overflow-hidden w-full">
						...
						<div className="flex flex-wrap w-full md:w-1/2 ">
							<div className="w-full md:w-full md:pr-2 md:h-[465px] h-[300px]">
								<Image
									alt="gallery"
									className="w-full h-[350px] md:h-full object-cover object-center block rounded-lg"
									src={getUEImageURL(home?.image)}
									width={500}
									height={300}
								/>
							</div>
						...
						{/* Resized Images */}
						<div className="flex-wrap w-1/2 hidden md:flex">
